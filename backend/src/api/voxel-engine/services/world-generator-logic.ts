import { BiomeType, BlockType, Chunk, Tile, WorldConfig, ZLevel } from './utils/types';
...
export class WorldGenerator {
  ...
  private applyCivilization(_chunkX: number, _chunkY: number, tiles: Tile[][][], wOffX: number, wOffY: number) {
