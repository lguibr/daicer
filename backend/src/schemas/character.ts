...
const avatarAssetsSchema = z.object({
  portrait: assetResponseSchema,
  upperBody: assetResponseSchema,
  fullBody: assetResponseSchema,
});
...
export const characterSheetSchema = z.object({
  ...
  avatarAssets: avatarAssetsSchema.nullable().optional(),
