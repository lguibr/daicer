            ...
            <section>
              ...
              {avatarAssets ? (
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  {[
                    { label: 'Portrait', asset: avatarAssets.portrait },
                    { label: 'Upper Body', asset: avatarAssets.upperBody },
                    { label: 'Full Body', asset: avatarAssets.fullBody },
                  ].map(({ label, asset }) => (
                    <figure
                      key={label}
                      className="group relative overflow-hidden rounded-xl border border-shadow-700 bg-shadow-900/70"
                    >
                      <img
                        src={asset.publicUrl}
