...
export const WithCreatures: Story = {
  args: {
    players: [createPlayer({})],
    creatures: [
      { name: 'Goblin Scout', hp: 7, maxHp: 15, attackBonus: 4, damage: '1d6+2' },
      { name: 'Dire Wolf', hp: 22, maxHp: 37, attackBonus: 5, damage: '2d6+3' },
    ],
  },
};
...
export const FullPartyWithEnemies: Story = {
  args: {
    ...
    creatures: [
      { name: 'Goblin King', hp: 45, maxHp: 45, attackBonus: 6, damage: '2d6+3' },
      { name: 'Goblin Warrior', hp: 12, maxHp: 15, attackBonus: 4, damage: '1d6+2' },
      { name: 'Goblin Warrior', hp: 8, maxHp: 15, attackBonus: 4, damage: '1d6+2' },
    ],
  },
};
