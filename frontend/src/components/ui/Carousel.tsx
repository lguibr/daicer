...
export function Carousel({
  ...
  return (
    <section
      ...
      role="group"
    >
      <div className="overflow-hidden rounded-3xl border border-aurora-400/15 bg-midnight-900/60 shadow-[0_30px_60px_rgba(6,9,16,0.45)] backdrop-blur">
        <div
        ...
        >
          {slides.map((slide, index) => (
            <div
              ...
              className="flex min-h-[320px] w-full flex-shrink-0 flex-col gap-6 px-6 py-10 sm:px-10 md:min-h-[360px] lg:px-14"
