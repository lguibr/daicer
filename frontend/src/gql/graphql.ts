...
export type CreateCharacterSheetMutation = {
  __typename?: 'Mutation';
  createCharacterSheet?: { __typename?: 'CharacterSheet'; documentId: string; name?: string | null } | null;
};
...
export const CreateCharacterSheetDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateCharacterSheet' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CharacterSheetInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<CreateCharacterSheetMutation, CreateCharacterSheetMutationVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'timeFrames' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'sort' },
                      value: { kind: 'StringValue', value: 'turnNumber:asc', block: false },
                    },
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'pagination' },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'turnNumber' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'timestamp' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'gameState' } },
                    ],
                  },
                },
                {
