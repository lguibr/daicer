      ...
      <div className="container mx-auto p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white">3D Voxel Models</h1>
            <p className="text-shadow-300">Generate voxel-based 3D models for creatures and objects</p>
          </div>
          {!selectedCollection && (
            <Button
              ...
              <Card className="border-accent/30 bg-gradient-to-br from-midnight-900/70 via-midnight-800/60 to-midnight-700/60">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="mt-2 text-sm text-shadow-400">
                    Create your first collection to organize your 3D assets
                  </p>
                </CardContent>
              </Card>
            ) : (
