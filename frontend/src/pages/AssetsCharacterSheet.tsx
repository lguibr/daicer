/**
 * Character Sheet Assets Page - D&D 5e Character Components
 */
...
export default function AssetsCharacterSheetPage() {
  ...
  const loadCollections = async () => {
    setLoading(true);
    try {
      const data = await getCollections('character-sheet');
      setCollections(data);
    } catch (err) {
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white">Character Sheet Assets</h1>
            <p className="text-shadow-300">Generate D&D 5e character sheets and templates</p>
          </div>
          {!selectedCollection && (
            <Button
              ...
              <Card className="border-accent/30 bg-gradient-to-br from-midnight-900/70 via-midnight-800/60 to-midnight-700/60">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="mt-2 text-sm text-shadow-400">
                    Create your first collection to organize your character sheet assets
                  </p>
                </CardContent>
              </Card>
            ) : (
