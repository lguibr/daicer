...
export const SRD_RULES = [
    ...
    // ============================================================================
    {
        ...
        title_es: 'Iniciativa',
        title_ptBR: 'Iniciativa',
        content_es: 'La iniciativa determina el orden de los turnos en el combate. Cuando comienza el combate, cada participante realiza una prueba de Destreza para determinar su lugar en el orden de iniciativa. El DM hace una tirada para todo un grupo de criaturas idénticas, por lo que cada miembro del grupo actúa al mismo tiempo. El DM clasifica a los combatientes en orden, desde el que tiene el total más alto de la prueba de Destreza hasta el que tiene el más bajo. Este es el orden (llamado orden de iniciativa) en el que actúan durante cada ronda. El orden de iniciativa permanece igual de una ronda a otra.',
        content_ptBR: 'A iniciativa determina a ordem dos turnos em combate. Quando o combate começa, cada participante faz um teste de Destreza para determinar seu lugar na ordem de iniciativa. O Mestre faz uma rolagem para todo um grupo de criaturas idênticas, para que cada membro do grupo aja ao mesmo tempo. O Mestre classifica os combatentes em ordem, daquele com o total mais alto no teste de Destreza até aquele com o mais baixo. Esta é a ordem (chamada ordem de iniciativa) na qual eles agem durante cada rodada. A ordem de iniciativa permanece a mesma de uma rodada para outra.',
    },
    {
        ...
        title_es: 'Acciones en Combate',
        title_ptBR: 'Ações em Combate',
        content_es: 'Cuando realizas tu acción en tu turno, puedes realizar una de las acciones presentadas aquí, una acción que obtuviste de tu clase o una característica especial, o una acción que improvises. Muchos monstruos tienen opciones de acción propias en sus bloques de estadísticas. Las acciones comunes incluyen: Atacar (realizar un ataque cuerpo a cuerpo o a distancia), Lanzar un Hechizo, Correr (ganar movimiento extra), Destrabarse (tu movimiento no provoca ataques de oportunidad), Esquivar (los ataques contra ti tienen desventaja), Ayudar (ayudar a un aliado), Esconderse (realizar una prueba de Destreza (Sigilo)), Preparar (preparar una acción para activar más tarde), Buscar (realizar una prueba de Sabiduría (Percepción) o Inteligencia (Investigación)), Usar un Objeto (interactuar con un objeto).',
        content_ptBR: 'Quando você realiza sua ação em seu turno, você pode realizar uma das ações apresentadas aqui, uma ação que você ganhou de sua classe ou uma característica especial, ou uma ação que você improvisa. Muitos monstros têm opções de ação próprias em seus blocos de estatísticas. As ações comuns incluem: Atacar (realizar um ataque corpo a corpo ou à distância), Conjurar uma Magia, Disparada (ganhar movimento extra), Desengajar (seu movimento não provoca ataques de oportunidade), Esquivar (os ataques contra você têm desvantagem), Ajudar (ajudar um aliado), Esconder-se (realizar um teste de Destreza (Furtividade)), Preparar (preparar uma ação para acionar mais tarde), Procurar (realizar um teste de Sabedoria (Percepção) ou Inteligência (Investigação)), Usar um Objeto (interagir com um objeto).',
    },
    {
        ...
        title_es: 'Acción Adicional',
        title_ptBR: 'Ação Bônus',
        content_es: 'Varias características de clase, hechizos y otras habilidades te permiten realizar una acción adicional en tu turno llamada acción adicional. Solo puedes realizar una acción adicional cuando una habilidad especial, hechizo u otra característica del juego indica que puedes hacer algo como acción adicional. De lo contrario, no tienes una acción adicional para realizar. Solo puedes realizar una acción adicional en tu turno, por lo que debes elegir qué acción adicional usar cuando tengas más de una disponible. Eliges cuándo realizar una acción adicional durante tu turno, a menos que se especifique el momento de la acción adicional.',
        content_ptBR: 'Várias características de classe, magias e outras habilidades permitem que você realize uma ação adicional em seu turno chamada ação bônus. Você só pode realizar uma ação bônus quando uma habilidade especial, magia ou outra característica do jogo declara que você pode fazer algo como ação bônus. Caso contrário, você não tem uma ação bônus para realizar. Você só pode realizar uma ação bônus em seu turno, portanto, deve escolher qual ação bônus usar quando tiver mais de uma disponível. Você escolhe quando realizar uma ação bônus durante seu turno, a menos que o momento da ação bônus seja especificado.',
    },
    {
        id: 'combat-movement',
